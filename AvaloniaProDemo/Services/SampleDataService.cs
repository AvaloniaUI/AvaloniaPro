...
using AvaloniaProDemo.Models;

namespace AvaloniaProDemo.Services;
...
public static class SampleDataService
{
    ...
    public static ObservableCollection<FileSystemNode> GetFileSystem()
    {
        return new ObservableCollection<FileSystemNode>
        {
            ...
            new() { Name = "AvaloniaProDemo.csproj", Size = 640, Modified = new DateTime(2025, 1, 10) },
        };
    }
    ...
    public const string SampleMarkdownReadme = """
        ...
        **Avalonia Pro** is a suite of premium components for building professional
        ...
        Avalonia Pro requires a valid license key. Visit [avaloniaui.net](https://avaloniaui.net/)
