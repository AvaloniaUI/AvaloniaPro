...
using VM = AvaloniaProDemo.ViewModels;
using View = AvaloniaProDemo.Views;
using AvaloniaProDemo.ViewModels.Tooling;
using AvaloniaProDemo.ViewModels;

namespace AvaloniaProDemo;
...
public class ViewLocator : IDataTemplate
{
    public Control? Build(object? param)
    {
        return param switch
        {
            ...
            ToolingOverviewViewModel => new View.Tooling.ToolingOverviewView(),
